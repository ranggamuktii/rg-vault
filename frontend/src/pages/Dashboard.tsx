            ...
            <div className="space-y-4">
              {stats?.recentNotes?.length ? (
                ...
                <div className="text-center py-8">
                  ...
                  <button type="button" aria-label="Create first note" onClick={() => setShowNoteModal(true)} className="text-sm text-blue-600 hover:text-blue-700 font-medium mt-2 inline-block">
            ...
            <div className="space-y-4">
              {stats?.recentLinks?.length ? (
                ...
                <div className="text-center py-8">
                  ...
                  <button type="button" aria-label="Save first link" onClick={() => setShowLinkModal(true)} className="text-sm text-blue-600 hover:text-blue-700 font-medium mt-2 inline-block">
            ...
            <div className="space-y-4">
              {stats?.recentFiles?.length ? (
                ...
                <div className="text-center py-8">
                  ...
                  <button type="button" aria-label="Upload first file" onClick={() => fileInputRef.current?.click()} className="text-sm text-blue-600 hover:text-blue-700 font-medium mt-2 inline-block">
              ...
              <div className="inline-block align-bottom bg-white rounded-2xl px-6 pt-6 pb-6 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form onSubmit={noteForm.handleSubmit(handleCreateNote)}>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button type="button" aria-label="Close note modal" title="Close note modal" onClick={() => setShowNoteModal(false)} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-xl transition-all">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input id="note-tags" {...noteForm.register('tags')} placeholder="work, personal, ideas" type="text" className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                  </div>
                  <div className="flex justify-end space-x-3 pt-6 mt-6 border-t border-gray-100">
                    <button type="button" onClick={() => setShowNoteModal(false)} className="px-6 py-3 text-sm font-medium text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200">
                      Cancel
                    </button>
                    <button type="submit" className="px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-xl hover:bg-blue-700">
                      Create Note
                    </button>
                  </div>
                </form>
              ...
              <div className="inline-block align-bottom bg-white rounded-2xl px-6 pt-6 pb-6 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form onSubmit={linkForm.handleSubmit(handleCreateLink)}>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button type="button" aria-label="Close link modal" title="Close link modal" onClick={() => setShowLinkModal(false)} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-xl transition-all">
                      <XMarkIcon className="h-5 w-5" />
                    </button>
                  </div>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input id="link-title" {...linkForm.register('title')} placeholder="Link title" type="text" className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                    ...
                    <div>
                      <label htmlFor="link-category" className="block text-sm font-medium text-gray-700 mb-2">
                        Category
                      </label>
                      <input
                        id="link-category"
                  ...
                  <div className="flex justify-end space-x-3 pt-6 mt-6 border-t border-gray-100">
                    <button type="button" onClick={() => setShowLinkModal(false)} className="px-6 py-3 text-sm font-medium text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200">
                      Cancel
                    </button>
                    <button type="submit" className="px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-xl hover:bg-blue-700">
                      Save Link
